...
# ╔═╡ 542d0745-d99b-4eaa-8635-054ec639837d
rand(X_Uniform)
...
# ╔═╡ 79f4da5e-194e-47d2-ab8e-bc6283755f9b
rand(X_Normal)

# ╔═╡ 32f40947-593e-48d9-9216-8dde1766da98
# Function for Plotting and Sampling a Continuous Distribution
function plotSampleContDist(X::UnivariateDistribution)
	local width = 500
	local height = 300
	...
	return @htl("""
	    ...
	    <h6 style="color: white; flex-basis: 45%; margin: 0; display: flex; align-items: center; justify-content: center;">Sampling Speed</h6>
		...
		<div style="background-color: grey; opacity: 0.75; width: $(width)px; height: $(slider_height)px; position: relative; display: flex; justify-content: center; align-items: center;">
			<input type="range" id=$(DistUUID*"-speed-slider") min="0" max="1000" step="25" value="1000" style="width: 45%;"/>
		...
		<script>
			...
			function updateArea() {
				...
				points += ` \${scaleX(x_vals[max_i])},\${scaleY(pdf_vals[max_i])}`;
...
plotSampleContDist(X_Uniform)

# ╔═╡ b96e5479-4c4e-42ee-a764-38602d250040
plotSampleContDist(X_Normal)
