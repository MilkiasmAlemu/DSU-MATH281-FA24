...
# ╔═╡ 4a853560-153a-4c6e-bacc-038c2e72ac3b
md"""
###### I want to see how likely it is that a person is over 165cm tall.
"""

# ╔═╡ b9055c8d-b87b-4a5c-956c-b1d78aeb2385
Heights = MyData[!, "Height"]

# ╔═╡ 27c37657-44cd-4d53-b536-305ffe5211b8
TallerHeights = filter(x -> x > 165, Heights)

# ╔═╡ ace83b42-53d0-4af9-9886-869fe262b1cf
length(TallerHeights)

# ╔═╡ 6a366a42-4535-42ed-a7ec-3b04a813fa9d
length(Heights)

# ╔═╡ 23ca77b6-d4eb-4d35-9fb6-72344d9e3ead
ProbA = 121 / 181

# ╔═╡ dfff57de-783a-4a86-ba1f-eaa90bbfa29e
md"""
###### It seems about 67% of people measured height is over 165cm.
"""

# ╔═╡ cd51a752-0ba9-49a1-8ffe-87497848db24
md"""
###### I wonder how many people have a reported height that is smaller than their actual height.
"""

# ╔═╡ 877e9f8d-23ce-480a-bd78-f9ce8c32bac6
ReportedHeights = MyData[!, "RepHt"]

# ╔═╡ 18b64af1-0281-4118-8640-9e3c086a2d98
Heights .> ReportedHeights

# ╔═╡ cfb2c568-ded0-4d9e-ac7e-14c1914ea4af
countmap(Heights .> ReportedHeights)

# ╔═╡ 138c0e1f-d221-400e-9c02-af6591f0cd3a
ProbB = 138 / (138 + 43)

# ╔═╡ 9c9d52c4-b55e-4b37-bbd7-2695b447c9da
md"""
###### It seems that 76% of people told the doctor that their height was smaller than their actual height by at least one centimeter.
"""

# ╔═╡ 5d0825ee-5538-4607-8365-1692a6210303
md"""
###### In order to compute conditional probabilities, I need to find the probability of the intersection!
"""

# ╔═╡ 428a2a9c-db84-4417-b9d3-5b76904c8f4d
countmap([(Heights[i] > 165) && (Heights[i] > ReportedHeights[i]) for i in 1:181])

# ╔═╡ de9f691d-5585-4bf8-aeca-5890904c3602
ProbBoth = 88 / (88 + 93)

# ╔═╡ 50158c55-287d-495f-9b46-b5a08b83555e
ProbAGivenB = ProbBoth / ProbB

# ╔═╡ e1e694e7-0e6e-46c9-b4d1-d768d7da5c8e
ProbBGivenA = ProbBoth / ProbA
...
ReportedWeights = MyData[!, "RepWt"]

# ╔═╡ 34645be1-c801-40d5-b23c-62b80ef20129
mean(ReportedWeights)

# ╔═╡ 11b95f98-1ae0-4630-9d77-6435c16c865a
std(ReportedWeights)

# ╔═╡ acc3e5a5-d933-4d53-b1e1-96d312990fb4
skewness(ReportedWeights)

# ╔═╡ b23f44c7-5d0f-4e6e-a390-4400c1dd4538
md"""
...
md"""
###### For me, I would probably say discrete, because people are probably not going to report that they are a decimal weight. Probably, they will round to the nearest kilogram, even though they may weigh some fractional amount.
"""

# ╔═╡ 9b3d7d94-bf08-4d1d-b47f-bb5981dd2fec
md"""
###### This looks either normal(ish) or maybe Poisson, since it does appear to be skewed a bit.
"""

# ╔═╡ 8e1cda49-2715-4de1-8075-3f2aba694b6c
mean(ReportedWeights)

# ╔═╡ d3147c49-01c4-4fe5-81e1-170c4d78e925
md"""
###### Since the mean of a Poisson distribution is given by the parameter λ, this mean should be the parameter.
"""

# ╔═╡ fba5ee6a-ca3c-49df-ad6b-fa9f8377a4a6
X = Poisson(65.679)

# ╔═╡ 0c24fbcc-142e-47e5-9e64-8b42fa6324a0
std(X)

# ╔═╡ 74748f75-5d13-4adc-abfe-62aab78612ac
skewness(X)

# ╔═╡ 1236fb43-dbac-4f94-b43b-b5267e881fc8
X2 = Normal(65.679, 13.834)

# ╔═╡ 69b2c43f-c95a-4509-9680-3172b20d330f
md"""
###### These definitely are not perfect, but it does capture at least some of the shape.
"""
...
# ╔═╡ 840945b4-1fce-4ab3-b23f-a887b9e252ee
plotDiscDist(X, ReportedWeights)
...
# ╔═╡ a59bbdf5-9d22-4435-b003-d33580ed4b74
plotContDist(X2, ReportedWeights)
...
# ╔═╡ cfa4f4f5-2b8e-4572-9809-253e08a6f442
plotLinePlot(ReportedWeights)
