...
# ╔═╡ e187ff17-1b19-40da-8469-97a0f1326958
...
# ╔═╡ b6695838-f80b-4b7c-ace0-f201ce4a1734
...
# ╔═╡ ee26dcff-9657-4129-8d1f-03ed34f30bf0


# ╔═╡ 11a181df-3f93-4584-aa11-0e2571fcf20e
@htl("""
	<hr>
""")

# ╔═╡ e3f25562-79e3-4b2b-90d9-e9b26f293589


# ╔═╡ 8c6776e5-2ad8-44b5-b908-3ebc493e2c04
@htl("""
	<hr>
""")

# ╔═╡ 0bdb95e6-6eb5-4151-ae54-c4a9480fda85
...
# ╔═╡ 693ee17b-d200-4b29-a9a5-9cfceb31be01
@htl("""
...
# ╔═╡ 021b3a9d-3dba-42af-b81f-b55c39ebfb71
@htl("""
...
* Compute the average of each of these different resamplings.\n
...
* Would you update your inferences about the population based off of these resampled values? If so, what would the updates tell you? If not, why not? Do you feel more confident in your assessments?"))
	...
	$(stop_box("Be aware that the central limit theorem only makes a statement about sampled means, and so it is reasonable that the histograms may not look normal."))
""")

# ╔═╡ bb76969f-1870-44e8-b758-dfff42b86cb0
@htl("""
